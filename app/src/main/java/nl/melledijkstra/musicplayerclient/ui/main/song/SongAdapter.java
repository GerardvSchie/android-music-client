...
public class SongAdapter extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    public class SongViewHolder extends BaseViewHolder {
        ...
        public void onBind(int position) {
            ...
            itemView.setOnClickListener(view -> mCallback.playSong((int)song.ID));
        }
        ...
        public boolean onMenuItemClick(MenuItem item, Song song) {
            ...
            if (itemId == R.id.menu_play_next) {
                mCallback.addSongNext((int)song.ID);
...
//                        }).show();
                ...
                AlertUtils.createAlert(itemView.getContext(), R.drawable.ic_action_trash, itemView.getContext().getResources().getString(R.string.delete), null)
